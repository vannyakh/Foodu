        ...
        <View className="px-3 pb-4 space-y-2">
          ...
          <View className="flex-row items-center space-x-1">
              ...
              <Text className="text-xs">
                  ...
                  <Text className="text-gray-700"> ({reviews} 1.5k)</Text> · <Text className="font-semibold text-gray-700">{type}</Text>
              </Text>
          </View>
          <View className="flex-row items-center space-x-1">
              ...
              <Text className="text-gray-700 text-xs">{distance} km</Text>
              <Text
              className="text-gray-700 text-xs"
              >
                |
              ...
              <Text className="text-gray-700 text-xs"> ${delivery}</Text>
          </View>
        </View>
      </View>
