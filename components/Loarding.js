    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          >
            <View
              style={{ ...styles.innerItem, backgroundColor: this.color1 }}
            ></View>
          </Animated.View>
          <Animated.View
          ...
          >
            <View
              style={{ ...styles.innerItem, backgroundColor: this.color2 }}
            ></View>
          </Animated.View>
          <Animated.View
          ...
          >
            <View
              style={{ ...styles.innerItem, backgroundColor: this.color3 }}
            ></View>
          </Animated.View>
          <Animated.View
          ...
          >
            <View
              style={{ ...styles.innerItem, backgroundColor: this.color4 }}
            ></View>
          </Animated.View>
          <Animated.View
          ...
          >
            <View
              style={{ ...styles.innerItem, backgroundColor: this.color5 }}
            ></View>
          </Animated.View>
        </Animated.View>
      </View>
