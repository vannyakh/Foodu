    ...
    <SafeAreaView className="flex-1 bg-white dark:bg-slate-800">
      ...
      <View className="relative py-4 shadow-sm flex items-center flex-row justify-center">
        ...
        <TouchableOpacity
          ...
          className="absolute z-10 rounded-full p-1 shadow  right-2"
        >
          <Icon.Edit strokeWidth={2} width={20} height={20} stroke={themeColors.bgColor(1)} />
        </TouchableOpacity>
      ...
      <ScrollView className="flex-1">
        <View className="flex flex-col gap-2 p-4">
          ...
          {/* socile connect facebook tiktok google */}
          <View
            className="flex flex-col gap-2 p-4 rounded-3xl"
            style={{ borderColor: themeColors.bgColor(1), borderWidth: 1 }}
          >
            <View className="flex flex-row justify-between items-center mb-6 ">
              <View className="flex flex-row  items-center gap-2">
                ...
                <Text className="text-gray-600 font-medium dark:text-gray-200" >Facebook</Text>
              </View>
            ...
            <View className="flex flex-row justify-between items-center mb-6">
              <View className="flex flex-row  items-center gap-2">
                <Image
                  source={require("../assets/images/logo_tk.png")}
                  style={{
                    width: 30,
                    height: 30,
                  }}
                  className="rounded-full"
                />
                <Text className="text-gray-600 font-medium dark:text-gray-200">Tiktok</Text>
              </View>
              <Text className=" font-normal"
                style={{ color: themeColors.bgColor(1) }}
              >Connect</Text>
            ...
            <View className="flex flex-row justify-between items-center mb-6">
              <View className="flex flex-row  items-center gap-2">
                <Image
                  ...
                  className="rounded-full"
                />
                <Text className="text-gray-600 font-medium dark:text-gray-200">Google</Text>
              </View>
              <Text
